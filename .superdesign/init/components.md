...
- `components/operator-brief.tsx`: compact retention brief below the Oracle cue on home and terminal; shows first-profit progress, a Heat ladder, and one next action for Hydra action-fatigue/heat-anxiety follow-up.
